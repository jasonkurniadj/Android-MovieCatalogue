...
import com.jasonkurniadj.moviecatalogue.fragment.MovieFragment;
...
public class GetSearchListTask extends AsyncTask<String, String, String> {
    ...
    public GetSearchListTask(Context context, int fragmentIdx) {
    ...
    protected String doInBackground(String... strings) {
        try {
            ...
            String _url = API_URL + "api_key=" + API_KEY + "&language=" + API_LANGUAGE + "&query=" + strings[0];
            ...
            ex.printStackTrace();
            Log.i(LOG_TAG, "Search AsyncTask Exception: " + ex.toString());
        }
        ...
        try {
            ...
            for (int i=0; i<jsonArray.length(); i++) {
                ...
                if (fragmentIdx == 1) {
                    ...
                    movieFragment.setMovieSearchInstance(modelList);
                }
                else if (fragmentIdx == 2) {
                    TvShowFragment tvShowFragment = new TvShowFragment();
                    tvShowFragment.setTvShowSearchInstance(modelList);
                }
            }
